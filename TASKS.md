...
- [x] Corregir lógica Booleana `NOT` (persistente en DB)
...
- [x] Implementar suite de pruebas automatizadas (Vitest + Playwright) (V2.3)
- [x] Crear Centro de Ayuda y Guía Clínica integrada (HelpView)
